...
ModelRadar 是一套面向 AI 从业者的实时模型情报监控系统。它同时盯着榜单、GitHub、HuggingFace、Reddit、厂商博客和 OpenRouter 用量数据，检测到 P0 级变动立即邮件告警，每周五 19:00 自动生成精美 HTML 周报。
...
| **📬 周报** | 每周五 19:00 自动生成 HTML 邮件周报（7 个板块），存档可回看 |
...
每周五 19:00 自动生成的 HTML 邮件包含 7 个板块：
